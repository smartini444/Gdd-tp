...
IF OBJECT_ID('BI_MODEL.LOCALIDAD', 'U') IS NULL
  ...
  IF OBJECT_ID('BI_MODEL.TIPO_MOVILIDAD', 'U') IS NULL
    ...
    CREATE TABLE BI_MODEL.USUARIO(
	 ...
	 IF OBJECT_ID('BI_MODEL.MEDIO_PAGO', 'U') IS NULL
		CREATE TABLE BI_MODEL.MEDIO_PAGO(
...
IF OBJECT_ID('BI_MODEL.RECLAMO', 'U') IS NULL
...
CREATE PROCEDURE BI_MEDIO_PAGO
AS
    BEGIN
		INSERT INTO BI_MODEL.MEDIO_PAGO(USUARIO_NRO,TIPO_MEDIO_PAGO)
...
AS
    BEGIN
		INSERT INTO BI_MODEL.USUARIO(USUARIO_NRO,EDAD)
		SELECT DISTINCT USUARIO_NRO,obtenerEdad(USUARIO_FECHA_NAC) FROM NEW_MODEL.USUARIO
    END
GO
...
CREATE PROCEDURE BI_ESTADO_RECLAMO
AS
    BEGIN
		INSERT INTO BI_MODEL.ESTADO_RECLAMO(ESTADO_RECLAMO_NRO,ESTADO_RECLAMO_NOMBRE)
		SELECT DISTINCT ESTADO_RECLAMO_NRO,ESTADO_RECLAMO_NOMBRE FROM NEW_MODEL.ESTADO_RECLAMO
    END
GO

CREATE PROCEDURE BI_PEDIDO_ESTADO
AS
    BEGIN
		INSERT INTO BI_MODEL.PEDIDO_ESTADO(PEDIDO_ESTADO_NRO,PEDIDO_ESTADO)
		SELECT DISTINCT PEDIDO_ESTADO_NRO,PEDIDO_ESTADO FROM NEW_MODEL.PEDIDO_ESTADO
    END
GO


CREATE PROCEDURE BI_MENSAJERIA_ESTADO
AS
    BEGIN
		INSERT INTO BI_MODEL.MENSAJERIA_ESTADO(ENVIO_MENSAJERIA_ESTADO, MENSAJERIA_ESTADO_NRO)
		SELECT ENVIO_MENSAJERIA_ESTADO,MENSAJERIA_ESTADO_NRO FROM NEW_MODEL.MENSAJERIA_ESTADO
    END
GO


CREATE PROCEDURE BI_CUPON
AS
    BEGIN
