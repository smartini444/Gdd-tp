...
RECLAMO_CUPON_TIPO_NRO int NULL,
...
FOREIGN KEY(RECLAMO_CUPON_NRO, RECLAMO_CUPON_TIPO_NRO) REFERENCES NEW_MODEL.CUPON(CUPON_NRO, CUPON_TIPO_NRO),
CONSTRAINT UQ_CUPON UNIQUE (RECLAMO_CUPON_NRO, RECLAMO_CUPON_TIPO_NRO)
...
BEGIN
	INSERT INTO NEW_MODEL.RECLAMO(RECLAMO_NRO, RECLAMO_USUARIO_NRO, RECLAMO_PEDIDO_NRO, RECLAMO_TIPO_RECLAMO_NRO, RECLAMO_ESTADO_RECLAMO_NRO, RECLAMO_OPERADOR_NRO, RECLAMO_CUPON_NRO, RECLAMO_CUPON_TIPO_NRO, RECLAMO_FECHA, RECLAMO_DESCRIPCION, RECLAMO_FECHA_SOLUCION, RECLAMO_SOLUCION, RECLAMO_CALIFICACION)
