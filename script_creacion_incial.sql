...
--  index para evitar repetidos por permitir NULLS 
...
AS
	BEGIN
		...
		SELECT @operadorNro = OPERADOR_NRO FROM NEW_MODEL.OPERADOR WHERE @operadorDni = OPERADOR_RECLAMO_DNI AND @operadorNombre = OPERADOR_RECLAMO_NOMBRE AND @operadorNombre = OPERADOR_RECLAMO_APELLIDO;
		RETURN @operadorNro
	END
GO
