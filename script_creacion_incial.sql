...
AS
    BEGIN
        INSERT INTO NEW_MODEL.PEDIDO(PEDIDO_NRO, PEDIDO_ENVIO_NRO, PEDIDO_ESTADO_NRO, PEDIDO_USUARIO_NRO, PEDIDO_TOTAL_CUPONES, PEDIDO_TOTAL_SERVICIO, PEDIDO_PROPINA, PEDIDO_PRECIO_ENVIO, PEDIDO_TARIFA_SERVICIO, -- PEDIDO_TOTAL_PRODUCTOS,
        PEDIDO_CALIFICACION, PEDIDO_TIEMPO_ESTIMADO)
        ...
        PEDIDO_CALIFICACION, PEDIDO_TIEMPO_ESTIMADO_ENTREGA FROM gd_esquema.Maestra
        WHERE PEDIDO_NRO IS NOT NULL
