...
CREATE TABLE NEW_MODEL.PRDUCTO(
...
CREATE TABLE NEW_MODEL.ITEM(
    ITEM_LOCAL_NRO int REFERENCES NEW_MODEL.LOCAL,
    ITEM_PRODUCTO_NRO int REFERENCES NEW_MODEL.PRODUCTO,
    ...
    PRIMARY KEY(ITEM_PRODUCTO_NRO, ITEM_LOCAL_NRO,ITEM_PEDIDO_NRO)
);

CREATE TABLE NEW_MODEL.RECLAMO(
	RECLAMO_NRO	int IDENTITY PRIMARY KEY,
	RECLAMO_USUARIO_NRO int REFERENCES NEW_MODELO.USUARIO,
	RECLAMO_PEDIDO_NRO int REFERENCES NEW_MODELO.PEDIDO,
	RECLAMO_TIPO_RECLAMO int REFERENCES NEW_MODELO.TIPO_RECLAMO,
	RECLAMO_ESTADO_RECLAMO_NRO int REFERENCES NEW_MODELO.ESTADO_RECLAMO,
	RECLAMO_OPERADOR_DNI int REFERENCES NEW_MODELO.OPERADOR NOT NULL,
...
CREATE TABLE NEW_MODEL.OPERADOR(
	...
	OPERADOR_RECLAMO_DNI_NUMERO int IDENTITY PRIMARY KEY,
