...
CREATE PROCEDURE migrar_usuarios2
AS
    BEGIN
...
CREATE PROCEDURE MIGRAR_USUARIOS AS
BEGIN
	SET IDENTITY_INSERT NEW_MODEL.USUARIO ON
	INSERT INTO NEW_MODEL.USUARIO(USUARIO_NOMBRE,USUARIO_APELLIDO,USUARIO_DNI,USUARIO_FECHA_REGISTRO,USUARIO_TELEFONO,USUARIO_MAIL,USUARIO_FECHA_NAC)
		SELECT DISTINCT USUARIO_NOMBRE,USUARIO_APELLIDO,USUARIO_DNI,USUARIO_FECHA_REGISTRO,USUARIO_TELEFONO,USUARIO_MAIL,USUARIO_FECHA_NAC 
        FROM gd_esquema.Maestra
		WHERE USUARIO_DNI IS NOT NULL
	SET IDENTITY_INSERT NEW_MODEL.USUARIO OFF
END
GO

SELECT [name] FROM sys.procedures
EXEC MIGRAR_USUARIOS
EXEC migrar_usuarios2

select * from NEW_MODEL.USUARIO

-- CREATE PROCEDURE NEW_MODEL.MIGRAR_PEDIDO AS
-- BEGIN
-- 	SET IDENTITY_INSERT NEW_MODEL.PEDIDO ON
...
-- 	SET IDENTITY_INSERT NEW_MODEL.PEDIDO OFF
-- END
-- GO



-- CREATE PROCEDURE NEW_MODEL.MIGRAR_ITEM AS
-- BEGIN
-- 	SET IDENTITY_INSERT NEW_MODEL.ITEM ON
...
-- 		--WHERE ?? IS NOT NULL
-- 	SET IDENTITY_INSERT NEW_MODEL.ITEM OFF
-- END
-- GO


-- CREATE PROCEDURE NEW_MODEL.MIGRAR_PRODUCTO AS
-- BEGIN
-- 	--SET IDENTITY_INSERT NEW_MODEL.PRODUCTO ON
...
-- CREATE PROCEDURE NEW_MODEL.MIGRAR_LOCAL AS
-- BEGIN
-- 	SET IDENTITY_INSERT NEW_MODEL.LOCAL ON
...
-- CREATE PROCEDURE NEW_MODEL.MIGRAR_TIPO_LOCAL AS
-- BEGIN
-- 	SET IDENTITY_INSERT NEW_MODEL.TIPO_LOCAL ON
...
-- CREATE PROCEDURE NEW_MODEL.MIGRAR_PEDIDO_ESTADO AS
-- BEGIN
-- 	SET IDENTITY_INSERT NEW_MODEL.PEDIDO_ESTADO ON
...
-- CREATE PROCEDURE NEW_MODEL.MIGRAR_TIPO_MOVILIDAD AS
-- BEGIN
-- 	SET IDENTITY_INSERT NEW_MODEL.TIPO_MOVILIDAD ON
...
-- CREATE PROCEDURE NEW_MODEL.MIGRAR_REPARTIDOR AS
-- BEGIN
-- 	SET IDENTITY_INSERT NEW_MODEL.REPARTIDOR ON
-- 	INSERT INTO NEW_MODEL.REPARTIDOR(REPARTIDOR_NOMBRE , REPARTIDOR_APELLIDO ,REPARTIDOR_DNI,REPARTIDOR_TELEFONO,REPARTIDOR_DIRECION ,REPARTIDOR_EMAIL ,REPARTIDOR_FECHA_NAC )
...
-- CREATE PROCEDURE NEW_MODEL.MIGRAR_ AS
-- BEGIN
-- 	SET IDENTITY_INSERT NEW_MODEL. ON
-- 	INSERT INTO NEW_MODEL.()
