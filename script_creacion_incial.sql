...
--     ITEM_LOCAL_PRODUCTO_LOCAL_NRO int REFERENCES NEW_MODEL.LOCAL_PRODUCTO(LOCAL_PRODUCTO_LOCAL_NRO),
--     ITEM_LOCAL_PRODUCTO_PRODUCTO_NRO int REFERENCES NEW_MODEL.LOCAL_PRODUCTO(LOCAL_PRODUCTO_PRODUCTO_NRO),
